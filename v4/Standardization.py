...
def action():
    att=["X1", "X2", "X3", "X4", "X5", "X6", "ID", "SEX", "AGE", "EDUCATION", "MARRIAGE", "LIMIT_BAL", "BILL_AMT1", "BILL_AMT2", "BILL_AMT3", "BILL_AMT4", "BILL_AMT5", "BILL_AMT6", "PAY_AMT1", "PAY_AMT2", "PAY_AMT3", "PAY_AMT4", "PAY_AMT5", "PAY_AMT6", "target"]
    data = pd.io.parsers.read_csv('static/pca.csv',
         delimiter=',',
         header=0,
        );
